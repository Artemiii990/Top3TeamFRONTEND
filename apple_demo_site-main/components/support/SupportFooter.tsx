...
const COLUMNS: { heading: string; links: string[] }[] = [
  {
    ...
    links: [
      ...
      'Music',
      'TV',
      'Карта вебсайту служби підтримки',
    ],
  },
  {
    heading: 'Ремонт і обслуговування',
    links: ['Гарантії на апаратне забезпечення', 'Ліцензійні угоди про використання ПЗ', 'Безкоштовна підтримка'],
  },
  {
    heading: 'Ресурси',
    links: ['Моя підтримка', 'Документація до продуктів', 'Відео служби підтримки Apple', 'Доступність'],
  },
  {
    heading: 'Контакти',
    links: ['Зверніться до нас', 'Програма «Підтримка Apple»', 'Спільнота Apple'],
  },
];
  ...
  return (
    <footer className={s.footer}>
      ...
      <div className={s.breadcrumbs}>
        ...
        <a href="/support" className={s.crumbActive}>Підтримка</a>
      </div>
