  ...
  return (
    <footer className={s.footer}>
      ...
      <div className={s.notes}>
        <p>1. Інтегрований монітор серцевого ритму призначений для використання під час тренувань із додатком «Фітнес» і сумісними сторонніми додатками на iPhone 
        ...
        <p>2. Потрібні сумісні апаратні й програмні засоби. Працює із сумісним контентом у додатках, які підтримують цю технологію. Не весь контент доступний у форматі 
          Dolby Atmos. iPhone із камерою TrueDepth потрібен для створення персонального профілю просторового аудіо, який буде синхронізуватися на пристроях Apple 
          з останніми версіями операційних систем, зокрема iOS, iPadOS, macOS і tvOS. </p>
        ...
        <p>◊◊ Інтегрований монітор серцевого ритму призначений для використання під час тренувань із додатком «Фітнес» і сумісними сторонніми додатками на iPhone 
          з iOS 26 та новішої версії. Детальніше на <MenuLink href='/support/how-to-check-your-heart-rate'> support.apple.com/uk-ua/123184 </MenuLink>. </p>
        <p>◊◊◊ Доступно на AirPods 4 з активним поглинанням шуму або AirPods Pro 2 та пізніших моделях з останньою версією прошивки в парі з сумісними пристроями 
          з iOS 18, iPadOS 18 або macOS Sequoia чи новіших версій. Доступно на AirPods Max 2 з останньою версією прошивки в парі з сумісними пристроями з iOS 26.4, 
          iPadOS 26.4 або macOS 26.4 чи новіших версій. </p>
        <p>Δ До 1,5 раза ефективніше порівняно з попереднім поколінням активне поглинання шуму під час тестування відповідно до стандарту IEC 60268‑24. </p>
        <p>ΔΔ Потрібні сумісні апаратні й програмні засоби. Працює із сумісним контентом у додатках, які підтримують цю технологію. Не весь контент доступний у форматі 
          Dolby Atmos. iPhone із камерою TrueDepth потрібен для створення персонального профілю просторового аудіо, який буде синхронізуватися на пристроях Apple 
          з останніми версіями операційних систем, зокрема iOS, iPadOS, macOS і tvOS. </p>
        <p>ΔΔΔ Для прослуховування аудіо із наднизькою затримкою і звуком без втрат потрібне підʼєднання за допомогою кабелю USB‑C та сумісний контент із додатків 
          і сервісів, які підтримують цей формат. </p>
        <p>^ Час роботи від акумулятора залежить від параметрів пристрою, середовища, способу використання та багатьох інших факторів. </p>
        <p>^^ Доступно на сумісних пристроях з iOS 18, iPadOS 18 або macOS Sequoia чи новіших версій в парі з AirPods 4, AirPods 4 з активним поглинанням шуму 
          або AirPods Pro 2 та пізнішими моделями з останньою версією прошивки. Для кращої продуктивності оновіть програмні засоби до останньої версії. </p>
        <p>^^^ Тестування проводила компанія Apple у січні та лютому 2026 року на контрольних зразках AirPods Max 2, які було об’єднано в пару з контрольними зразками 
          iPhone 17 Pro Max із версією програмного засобу, яка готувалася до випуску. Було складено добірку, що містила 358 музичних композицій, придбаних в iTunes Store 
          (256 Кбіт/с в AAC‑кодуванні). Гучність становила 50%, активне поглинання шуму було ввімкнено, а просторове аудіо встановлено на фіксоване значення. У процесі 
          тестування визначалася тривалість роботи акумуляторів AirPods Max під час відтворення аудіо, яке тривало доти, доки навушники не припиняли роботу. Час роботи 
          від акумулятора залежить від параметрів пристрою, середовища, способу використання та багатьох інших факторів. </p>
      </div>
      ...
      <div className={s.breadcrumbs}>
        ...
        <a className={s.crumbActive}>AirPods</a>
      </div>
